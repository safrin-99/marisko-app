...
import { ScrollText, Edit, Trash2, RefreshCw, Clock, X, CheckCircle2, AlertCircle, Printer, FileText, Search, Download } from 'lucide-react';
...
export default function NotaPage() {
  ...
  const exportToExcel = () => {
    ...
    let csvContent = `No. Invoice,Tanggal,Kasir,Penerima,Kategori,Total Nominal (Rp)\n`;
    ...
    link.setAttribute("download", `Laporan_Nota_${kategoriNota}_${new Date().toISOString().slice(0,10)}.csv`);
          ...
          <div className="bg-slate-50/80 border-b border-slate-200 p-4 md:p-5 flex flex-col justify-between items-start gap-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full gap-3.5">
              <h3 className="text-lg font-bold text-slate-800 flex items-center">
                <ScrollText className="w-5 h-5 mr-2 text-indigo-600" /> Riwayat Nota {kategoriNota}
              </h3>
